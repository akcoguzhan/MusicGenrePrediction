...
{
    /*
    ** WPF binding işlemlerinde matematiksel operasyonlara izin verilmesine imkan tanır
    ** REF: https://rachel53461.wordpress.com/2011/08/20/the-math-converter/
     */
    public class MathConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                MessageBox.Show("Binding Hatası. Matematiksel işlemi kontrol ediniz.");
